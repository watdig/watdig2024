...
NODES=("csv_parse" "navigator_node" "controls_node" "action_server" "position_subscriber" "localization_node" "gyro_node" "front_uwb_node" "rqt_graph" "rosbridge_websocket")
